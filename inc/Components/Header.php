...
class Header {
	...
	public function hooks() {
		add_action( 'fh_header', array( get_class( $this ), 'logo' ), 7 );
		add_action( 'fh_header', array( get_class( $this ), 'primary_menu' ), 9 );
		add_action( 'fh_header', array( get_class( $this ), 'actions_wrapper' ), 11 );
	}
